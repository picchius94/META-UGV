# Heuristic Function Experiment
# The vehicle first collect 3 example pairs from an initial navigation
# Then, three different algorithms are used to plan a path to the next target
# 1) Meta-Adaptive: set this with 'meta'
# 2) Meta-Optimal: set this with 'meta_0'
# 3) Meta-ARA*: set this with 'meta_inf'
